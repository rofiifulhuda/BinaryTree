 ...
 * @author Rofiif
 */
public class LinkedBinaryTree extends BinaryTreeADT implements ExtendedBinaryTree, Cloneable{
    BinaryTreeNode root;
    static Method visit;
    ...
    public void preOrderOutput() throws InvocationTargetException{
        preOrder(theOutput);
    }
    
    public void preOrder(Method visit) throws InvocationTargetException{
        LinkedBinaryTree.visit = visit;
        thePreOrder(root);
    }
    
    static void thePreOrder(BinaryTreeNode t) throws InvocationTargetException{
        if(t!= null){
            visitArgs[0]= t;
            try{
